...
class ComportamientoJugador : public Comportamiento {
  public:
    ...
    bool veAlColaborador(Sensores sensores);
    list <Action> AnchuraLvl1(const stateN0 &inicio, const ubicacion &final, const vector<vector<unsigned char> > &mapa);
    bool esSolucion(const stateN0 &actual, const ubicacion &final);
    bool clbEnSensoresHipoteticos(const stateN0 &estado);

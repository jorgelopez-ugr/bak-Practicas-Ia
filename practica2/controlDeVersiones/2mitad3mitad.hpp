...
struct node2{
  ...
  bool operator==(const node2 &n) const{
    return ((st == n.st) && (coste_total_secuencia == n.coste_total_secuencia) && tieneBikini == n.tieneBikini && tieneZapatillas == n.tieneZapatillas);
  }
  ...
  bool operator<(const node2 &b) const{
    ...
    else if (st.jugador.f == b.st.jugador.f && st.jugador.c == b.st.jugador.c && st.jugador.brujula == b.st.jugador.brujula && tieneBikini < b.tieneBikini)
    {
      return true;
    }
    else if (st.jugador.f == b.st.jugador.f && st.jugador.c == b.st.jugador.c && st.jugador.brujula == b.st.jugador.brujula && tieneBikini == b.tieneBikini && tieneZapatillas < b.tieneZapatillas)
    {
      return true;
    }
    else
  ...
  void operator=(const node2 &otro){
    st = otro.st;
    coste_total_secuencia = otro.coste_total_secuencia;
...
struct node3{
  ...
  bool operator==(const node3 &n) const{
    return ((st == n.st) && (coste_total_secuencia == n.coste_total_secuencia) 
          && tieneBikini_jugador == n.tieneBikini_jugador && tieneZapatillas_jugador == n.tieneZapatillas_jugador
          && tieneBikini_colab == n.tieneBikini_colab && tieneZapatillas_colab == n.tieneZapatillas_colab);
  }
  ...
  bool operator<(const node3 &b) const{
    ...
    else if (st.jugador.f == b.st.jugador.f && st.jugador.c == b.st.jugador.c && st.jugador.brujula == b.st.jugador.brujula && tieneBikini_jugador < b.tieneBikini_jugador)
    {
      return true;
    }
    else if (st.jugador.f == b.st.jugador.f && st.jugador.c == b.st.jugador.c && st.jugador.brujula == b.st.jugador.brujula && tieneBikini_jugador == b.tieneBikini_jugador && tieneZapatillas_jugador < b.tieneZapatillas_jugador)
    {
      return true;
    }
    else if (st.jugador.f == b.st.jugador.f && st.jugador.c == b.st.jugador.c && st.jugador.brujula == b.st.jugador.brujula && tieneBikini_jugador == b.tieneBikini_jugador && tieneZapatillas_jugador == b.tieneZapatillas_jugador && tieneBikini_jugador < b.tieneBikini_colab)
    {
      return true;
    }
    else if (st.jugador.f == b.st.jugador.f && st.jugador.c == b.st.jugador.c && st.jugador.brujula == b.st.jugador.brujula && tieneBikini_jugador == b.tieneBikini_jugador && tieneZapatillas_jugador == b.tieneZapatillas_jugador && tieneBikini_jugador == b.tieneBikini_colab && tieneZapatillas_colab < b.tieneZapatillas_colab)
    {
      return true;
    }    
    else
  ...
  void operator=(const node3 &otro){
    st = otro.st;
    coste_total_secuencia = otro.coste_total_secuencia;
...
class ComportamientoJugador : public Comportamiento {
  public:
    ...
    list <Action> AnchuraN3(const state &inicio, const ubicacion &final, const vector<vector<unsigned char> > &mapa);
    ...
    void programarAccionJugador(Action accion, const node &actual, const vector<vector<unsigned char> > &mapa);
